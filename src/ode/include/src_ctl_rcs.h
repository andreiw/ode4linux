 ...
 * HISTORY
 * $Log: src_ctl_rcs.h,v $
 * Revision 1.1.6.4  1994/01/20  22:12:41  marty
 * 	CR # 917 - More fixes
 * 	[1994/01/20  22:11:02  marty]
 *
 * 	CR # 917 - Adjust for RCSfile lines
 * 	[1994/01/20  21:08:10  marty]
 *
 * Revision 1.1.6.3  1994/01/20  00:15:30  marty
 * 	CR # 917 - Leave file in sandbox identical to checked in version.
 * 	[1994/01/20  00:11:51  marty]
 * 
 * Revision 1.1.6.2  1993/12/07  19:54:05  marty
 * 	CR # 890 - Add is_branch().
 * 	[1993/12/07  19:53:36  marty]
 * 
 * Revision 1.1.6.1  1993/11/19  19:33:17  damon
 * 	CR 790. bcreate now complains if no user branch on undo
 * 	[1993/11/19  19:25:08  damon]
 * 
...
ERR_LOG
src_ctl_undo_create( const char *, const char * );
ERR_LOG
...
src_ctl_diff_rev_with_file( const char * rev, const char * filename,
                            ...
                            BOOLEAN whitespace, BOOLEAN unified,
			    ERR_LOG * log );
int
