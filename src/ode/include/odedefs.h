 ...
 * HISTORY
 * $Log: odedefs.h,v $
 * Revision 1.2.12.2  1994/02/04  16:09:53  damon
 * 	CR 827. Change xlog option to -x
 * 	[1994/02/04  16:09:45  damon]
 *
 * Revision 1.2.12.1  1993/11/23  16:53:34  damon
 * 	CR 747. Added user selectable ancestor check-out
 * 	[1993/11/23  16:53:21  damon]
 * 
...
#define ON_OP		"-on"
#define ON_OS_OP	"-on_os"
#define ON_OBJFMT_OP	"-on_objfmt"
#define OUTDATE_OP	"-o"
#define PRINT_TO_SCREEN_OP      "-p"
...
#define TARGET_OP	"-target"
#define TARGET_OS_OP	"-target_os"
#define TARGET_OBJFMT_OP "-target_objfmt"
#define FUNLOCK_OP   "-u"
#define UNDO_OP	"-undo"
#define UNIFIED_OP	"-u"
