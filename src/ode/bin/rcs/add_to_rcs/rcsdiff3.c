 ...
 * HISTORY
 * $Log: rcsdiff3.c,v $
 * Revision 1.1.2.1  1995/05/18  02:42:45  robert
 * 	add to tree for free & unencumbered distribution
 * 	[1995/05/18  02:41:45  robert]
 *
 * Revision 1.1.2.2  1993/01/11  18:08:41  damon
 * 	CR 386. Moved from ODE
 * 	[1993/01/11  18:08:18  damon]
 * 
 * Revision 1.4.2.2  1992/12/02  19:20:13  damon
 * 	CR 183. Added CMU notice
 * 	[1992/12/02  19:19:42  damon]
 * 
 * Revision 1.4  1991/12/05  20:52:24  devrcs
 * 	ODE 2.1
 * 
 * Revision 1.3.3.2  1991/10/16  10:18:50  marty
 * 	Fix command line processing to handle null arguments and added
 * 	exit(0) for status code.
 * 	[91/10/16  10:18:00  marty]
 * 
...
static char rcsid[] = "@(#)$RCSfile: rcsdiff3.c,v $ $Revision: 1.1.2.1 $ (OSF) $Date: 1995/05/18 02:42:45 $";
#endif
